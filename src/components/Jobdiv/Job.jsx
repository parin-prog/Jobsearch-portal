...
const Job = () => {
  return (
    <div>
      <div className='jobContainer flex gap-10 justify-center flex-wrap
        items-center py-10'>
        <div className='group group/item singleJob w-[250px]
            p-[20px] bg-white rounded mx-[10px] hover:bg-blueColor shadow-lg shadow-greyIsh-400/700
            hover:shadow-lg'>
          ...
          <p className='text-[13px] text-[#95959] pt-[20px] border-t-[2px] mt-[20px]
            ...
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum officiis eum alias, laborum,
            dolor tenetur quia qui animi.
          </p>
